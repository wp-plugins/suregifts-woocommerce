...
class Suregiftscheckout_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'suregiftscheckout'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'suregiftscheckout'); ?></h2>
            <table class="form-table"><tbody>
            <tr><td><?php _e('System', 'suregiftscheckout'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'suregiftscheckout'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'suregiftscheckout');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'suregiftscheckout'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'suregiftscheckout');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'suregiftscheckout'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'suregiftscheckout') ?>"/>
                </p>
            </form>
        </div>
        <?php
        ...
        //
       // print_r($this->getOption('ATextInput'));
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'suregiftscheckout');
            case 'false':
                return __('false', 'suregiftscheckout');

            case 'Administrator':
                return __('Administrator', 'suregiftscheckout');
            case 'Editor':
                return __('Editor', 'suregiftscheckout');
            case 'Author':
                return __('Author', 'suregiftscheckout');
            case 'Contributor':
                return __('Contributor', 'suregiftscheckout');
            case 'Subscriber':
                return __('Subscriber', 'suregiftscheckout');
            case 'Anyone':
                return __('Anyone', 'suregiftscheckout');
        }
        return $optionValue;
    }
